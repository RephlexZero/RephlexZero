...
<svelte:head>
  ...
  <meta
    name="description"
    content="Embedded systems engineer specialising in Rust, C, Linux, and hardware design."
  />
</svelte:head>
...
<section class="hero">
  ...
  <div class="hero-content">
    ...
    <p class="sub">
      EEE student. I design circuits, write firmware, and occasionally make
      software that talks to the real world.
    </p>
    <div class="cta-group">
