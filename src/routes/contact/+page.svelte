...
<section class="contact">
  ...
  {:else}
    ...
    >
      ...
      <label>
        <span>Message</span>
        <textarea name="message" bind:value={message} rows="5" required
        ></textarea>
      </label>
  ...
  <div class="alt-contact">
    ...
    <div class="social-links">
      <a
        href="https://github.com/RephlexZero"
        target="_blank"
        rel="noopener noreferrer"
        class="social-chip social-gh"
      >
        GitHub
      </a>
      <a
        href="https://www.linkedin.com/in/jake-stewart-360444272/"
        target="_blank"
        rel="noopener noreferrer"
        class="social-chip social-li"
      >
        LinkedIn
      </a>
